...
<template>
  <header class="topbar" role="banner">
    <Topbar
      :now-time="store.state.app.nowTime"
  ...
  <main class="container">
    ...
    <DevicesPanel
      v-show="currentTab === 'devices'"
      :devices="store.state.devices"
    />
    <SchedulePanel
      v-show="currentTab === 'schedule'"
      :list="store.state.schedule"
      @add="store.addSchedule"
    />
    <AlertsPanel
      v-show="currentTab === 'alerts'"
      :history="store.state.alerts.history"
      @clear="store.clearAlerts"
    />
    <EnergyPanel
      v-show="currentTab === 'energy'"
      :energy="store.state.energy"
    />
    <EnvironmentPanel
      v-show="currentTab === 'environment'"
      :env="store.state.env"
    />
    <VisitorsPanel
      v-show="currentTab === 'visitors'"
      :visitors="store.state.visitors"
    />
    <SettingsPanel
      v-show="currentTab === 'settings'"
      :dark="store.state.app.darkMode"
      @toggle-dark="store.toggleDark"
